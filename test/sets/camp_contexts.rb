module Contexts
  module CampContexts
    ...
    def create_custom_camps
      @camp5 = FactoryBot.create(:camp, curriculum: @tactics, location: @north, start_date: Date.new(2018,7,16), end_date: Date.new(2018, 8, 16), time_slot: 'am')
    end
    def delete_custom_camps
      @camp5.delete
    end
    ...
    def create_upcoming_camps
      # assumes create_more_curriculums prior
      @camp20 = FactoryBot.create(:camp, curriculum: @principles, start_date: Date.new(2018,6,11), end_date: Date.new(2018,6,15), time_slot: "am", location: @north, max_students: 2)
